...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int [] sayilar = new int [5]; // Bir değişken atayıp tanımladık yani  birden fazla dizi atadık.
                                       // ama atadığımız değer kadar ekleriz kaç değer var 5 tane 5 değer atadık.
        sayilar[0] =  100;
        sayilar[1] =  200;
        sayilar[2] =  300;
        sayilar[3] =  400;
        ...
        //   System.out.println(sayilar[5]);    sınırı aşma hatası verir.Bizim sınırımız 5' dir. Siz 123 tane
                                                //elemanın olmaz.Cevap da index'i aştınız.
        ...
        */              //    0    1   2   3
        ...
        for (int i = 0; i < myArrayByte.length; i++) { //hangi diziyi gireceksem onun sınırını veriyor.
